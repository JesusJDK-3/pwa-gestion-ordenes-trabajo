...
export const RESUMEN_DIARIO: ResumenDiario = {
  ...
  ordenes: [
    {
      id: 'OT-2026-0845',
      subactividadId: 'A1.37',
      estado: 'completada',
      direccion: 'Jr. Huallaga 450, Lima Centro',
      sector: 'Cercado Lima',
      horarioInicio: '07:15',
      horarioFin: '07:34',
      tiempoReal: 19,
    ...
    {
      id: 'OT-2026-0846',
      subactividadId: 'A2.15',
      estado: 'completada',
      direccion: 'Av. Abancay 320, Lima',
      sector: 'Cercado Lima',
      horarioInicio: '08:10',
      horarioFin: '08:52',
      tiempoReal: 42,
    ...
    {
      id: 'OT-2026-0847',
      subactividadId: 'A3.08',
      estado: 'completada',
      direccion: 'Jr. Camaná 850, Lima Centro',
      sector: 'Lima Centro',
      horarioInicio: '09:30',
      horarioFin: '09:52',
      tiempoReal: 22,
    ...
    {
      id: 'OT-2026-0848',
      subactividadId: 'A4.22',
      estado: 'completada',
      direccion: 'Jr. Azángaro 1120, Lima',
    ...
    {
      id: 'OT-2026-0849',
      subactividadId: 'A1.38',
      estado: 'completada',
      direccion: 'Av. Grau 550, La Victoria',
      sector: 'La Victoria',
      horarioInicio: '11:00',
      horarioFin: '11:35',
      tiempoReal: 35,
    ...
    {
      id: 'OT-2026-0851',
      subactividadId: 'A2.16',
      estado: 'completada',
      direccion: 'Av. Colonial 1450, Breña',
      sector: 'Breña',
      horarioInicio: '13:45',
      horarioFin: '14:12',
      tiempoReal: 27,
    ...
    {
      id: 'OT-2026-0852',
      subactividadId: 'A4.23',
      estado: 'completada',
      direccion: 'Jr. Quilca 330, Lima Centro',
      sector: 'Centro Histórico',
      horarioInicio: '14:30',
      horarioFin: '14:48',
      tiempoReal: 18,
